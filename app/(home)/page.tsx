          ...
          <div className="feat-grid">
            ...
            <div className="fc">
              <div className="fc-head">
                ...
                <div className="fc-desc">Every medication explained — dosage, purpose and side effects — in under 30 seconds.</div>
              </div>
      ...
      <section id="how-it-works" className="how-section">
        <div className="wrap">
          ...
          <div className="steps-path">
            <div className="step-card"><div className="step-num">1</div><div className="step-title">Take a photo or upload</div><div className="step-p">Any prescription or lab report. Messy handwriting included. Photos, PDFs, scans — all work.</div></div>
