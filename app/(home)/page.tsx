    ...
    <div className="hp">
      ...
      <section className="feat-section" id="features">
        ...
        <div className="wrap">
          <div className="tc">
            ...
            <h2 className="s-h2">Built around how you actually<br />use your <em className="hl">health records</em></h2>
            <p className="s-sub" style={{maxWidth:480,margin:'0 auto'}}>Not just extraction, but real understanding. Every feature is designed around a real moment of confusion.</p>
          </div>
          ...
          <div className="feat-grid">
            ...
            <div className="fc">
              <div className="fc-head">
                <div className="fc-icon-sm">
                  <svg width="18" height="18" fill="none" stroke="#1d4ed8" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                </div>
                <div className="fc-title">Plain-Language Explanations</div>
                <div className="fc-desc">Every medication explained in plain English: dosage, purpose, and side effects in under 30 seconds.</div>
              </div>
            ...
            <div className="fc">
              <div className="fc-head">
                <div className="fc-icon-sm">
                  <svg width="18" height="18" fill="none" stroke="#1d4ed8" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                </div>
                <div className="fc-title">Your Data Stays Yours</div>
                <div className="fc-desc">Your medical records are as private as a sealed envelope. Only you can see them, nobody else.</div>
              </div>
              <div className="fc-vis">
                <div className="fc-vis-box">
                  <div className="fc-vis-lbl">Privacy guarantee</div>
                  <div className="check-item c1"><div className="check-tick">✓</div>Only you can see your records</div>
                  <div className="check-item c2"><div className="check-tick">✓</div>Never shared or sold, ever</div>
                  <div className="check-item c3"><div className="check-tick">✓</div>Delete everything, any time</div>
                </div>
              </div>
            </div>
            ...
            <div className="fc">
              <div className="fc-head">
                <div className="fc-icon-sm">
                  <svg width="18" height="18" fill="none" stroke="#1d4ed8" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                </div>
            ...
            <div className="fc">
              <div className="fc-head">
                <div className="fc-icon-sm">
                  <svg width="18" height="18" fill="none" stroke="#1d4ed8" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </div>
                <div className="fc-title">Your Whole Family, One Place</div>
                <div className="fc-desc">One account for your parents, spouse and children. Everyone&apos;s health history always accessible.</div>
              </div>
              <div className="fc-vis">
                <div className="fc-vis-box">
            ...
            <div className="fc">
              <div className="fc-head">
                <div className="fc-icon-sm">
                  <svg width="18" height="18" fill="none" stroke="#1d4ed8" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                </div>
                <div className="fc-title">Lab Report Analysis</div>
                <div className="fc-desc">Upload any blood test or pathology report. Get a plain-language summary of every result with context on what&apos;s normal.</div>
              </div>
              <div className="fc-vis">
                <div className="fc-vis-box">
                  <div className="fc-vis-lbl">Blood test results</div>
                  <div className="med-row r1"><div className="med-dot" style={{background:'#16a34a'}} /><div className="med-lines"><div className="med-line d" /><div className="med-line" style={{width:'60%'}} /></div><div className="med-badge" style={{background:'#dcfce7',color:'#16a34a'}}>Normal</div></div>
                  <div className="med-row r2"><div className="med-dot" style={{background:'var(--pink)'}} /><div className="med-lines"><div className="med-line d" style={{width:'55%'}} /><div className="med-line" style={{width:'40%'}} /></div><div className="med-badge" style={{background:'var(--pink-s)',color:'var(--pink)'}}>Low ↓</div></div>
                  <div className="med-row r3"><div className="med-dot" style={{background:'var(--violet)'}} /><div className="med-lines"><div className="med-line d" style={{width:'75%'}} /><div className="med-line" style={{width:'50%'}} /></div><div className="med-badge" style={{background:'var(--violet-s)',color:'var(--violet)'}}>Review</div></div>
                </div>
              </div>
            </div>
            ...
            <div className="fc">
              <div className="fc-head">
                <div className="fc-icon-sm">
                  <svg width="18" height="18" fill="none" stroke="#1d4ed8" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684z"/></svg>
                </div>
      ...
      <section id="how-it-works" className="how-section">
        <div className="wrap">
          <div className="tc">
            ...
            <h2 className="s-h2">From confusing document<br />to clear answers in <em className="hl">60 seconds</em></h2>
          </div>
          <div className="steps-path">
            <div className="step-card"><div className="step-num">1</div><div className="step-title">Take a photo or upload</div><div className="step-p">Any prescription or lab report. Messy handwriting included. Photos, PDFs, and scans all work.</div></div>
            <div className="step-card"><div className="step-num">2</div><div className="step-title">We read it for you</div><div className="step-p">Our AI extracts every medication, dosage, and test result, even from unclear handwriting.</div></div>
            <div className="step-card"><div className="step-num">3</div><div className="step-title">Get a plain-language breakdown</div><div className="step-p">Every medication in plain English. What it treats, how to take it, what to watch for.</div></div>
            <div className="step-card"><div className="step-num">4</div><div className="step-title">Save to your health history</div><div className="step-p">Every record saved. Full family timeline. Never lose track of a diagnosis or prescription again.</div></div>
          </div>
        </div>
      </section>
      ...
      <section className="testi-section" id="testimonials">
        <div className="testi-head">
          ...
          <h2 className="s-h2">Real moments of <em className="hl">clarity</em></h2>
        </div>
        <div className="testi-grid">
          <div className="tcard">
            <p className="tcard-text">&ldquo;My father was on 7 medications after his surgery and nobody explained what they were for. I uploaded his prescription and finally understood everything — in under 2 minutes. I cried a little.&rdquo;</p>
            <div className="tcard-author"><div className="tcard-av">RS</div><div><div className="tcard-name">Rashmi S.</div><div className="tcard-role">Caregiver · Bangalore</div></div></div>
          </div>
          <div className="tcard">
            <p className="tcard-text">&ldquo;I was newly diagnosed with Type 2 diabetes and given 3 prescriptions I&apos;d never heard of. Vitae explained each one in plain English — what it does, how to take it, what to avoid. I felt in control for the first time.&rdquo;</p>
            <div className="tcard-author"><div className="tcard-av" style={{background:'rgba(29,78,216,.1)'}}>AK</div><div><div className="tcard-name">Amit K.</div><div className="tcard-role">Patient · Mumbai</div></div></div>
          </div>
          <div className="tcard">
            <p className="tcard-text">&ldquo;My son has asthma and every appointment ends with a new inhaler or tablet. I used to nod along without really understanding. Now I upload straight from the clinic and always know exactly what he&apos;s been prescribed.&rdquo;</p>
            <div className="tcard-author"><div className="tcard-av" style={{background:'rgba(29,78,216,.1)'}}>MT</div><div><div className="tcard-name">Meera T.</div><div className="tcard-role">Parent · Delhi</div></div></div>
          </div>
        </div>
      </section>
      ...
      <footer id="footer">
        <div className="foot-inner">
          ...
          <div>
            ...
            <form className="foot-newsletter-form" action="#">
